...
void sentInt(CommunicatingSocket *sock, uint32_t val) throw(SocketException);
...
/** Read survey questions from the given stream and store then in qList */
bool readSurvey(std::string &stream, std::vector<Question> &qList);
