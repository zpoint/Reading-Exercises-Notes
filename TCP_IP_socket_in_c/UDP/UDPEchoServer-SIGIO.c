...
int main(int argc, char *argv[])
{
		...
		// Go off and do real work; encoding happens in the background
...
void SIGIOHandler(int signalType)
{
		...
		do
		{
				...
				numBytesRcvd = recvfrom(servSock, buffer, BUFSIZ, 0, (struct sockaddr *)&clntAddr, (unsigned int *)&clntLen);
				if (numBytesRcvd < 0)
				{
				...
				else
				{
						...
						ssize_t numBytesSent = sendto(servSock, buffer, numBytesRcvd, 0, (struct sockaddr *)&clntAddr, clntLen);
						if (numBytesSent < 0)
