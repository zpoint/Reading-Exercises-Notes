package  {
	...
	public class Turret extends Sprite
	{
		...
		public function Turret(time_reload = 30, turr_range = 80,rect = false)
		{
			// constructor code
...
**********************************/
		...
		*/
		...
		private function onMouseClick(e:MouseEvent):void
		{
			...
			stage.addChild(button_up);
			button_up.x = 50;
			button_up.y = 550;
			stage.addChild(button_sell);
			button_sell.x = 130;
			button_sell.y = 550;
			/*
			button_sell.x = stag.stageWidth / 2 - 400;
			button_sell.y = stag.stageHeight - 150;
			*/
